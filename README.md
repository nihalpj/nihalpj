...
### Senior Product Manager | Fintech Architect | Edge AI & Open Source Enthusiast

<p align="left"> <img src="https://komarev.com/ghpvc/?username=nihalpj&label=Profile views&color=0e75b6&style=flat" alt="nihalpj" /> </p>

I am an experienced Fintech Product Manager specializing in the UPI ecosystem, currently building cutting-edge merchant solutions. Outside of finance, I am deeply passionate about edge AI, autonomous agent orchestration, and pushing the limits of local LLM execution on high-performance hardware.

- 🔭 **I'm currently working on:** - Building a robust User Merchant Management solution and UPI Payment Switch.
  - Developing an autonomous, AI-first Android 14 launcher (forking Kvaesitso) using `llama.cpp` for optimized local execution.
  - Building Web3/crypto platforms utilizing robust PostgreSQL architectures.
  - Developing a Red Teaming MCP Tool.

- 🌱 **I'm currently learning:** - Local LLM orchestration, agentic workflows, and RAG architectures.
...
- 💬 **Ask me about:** - **Fintech & Payments:** UPI Ecosystems, Merchant Switches, and Product Management.
  - **Hardware & AI:** High-performance PC builds for AI generation (e.g., maximizing L40s or RTX 4090 capabilities) and local LLM execution.

- 📫 **How to reach me:** [LinkedIn](http://www.linkedin.com/in/nihalpj)

- ⚡ **Fun fact:** I am a dairy-free foodie who has been weight training for over 12 years and practicing Muay Thai. When I'm not building tech, I'm analyzing BMW M-series engines or planning extensive cross-border driving expeditions.
